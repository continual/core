...
public interface ContinualMessagePublisher extends Closeable
{
	...
	{
		public TopicUnavailableException ( ) { super(); }
		public TopicUnavailableException ( Throwable t ) { super(t); }
		public TopicUnavailableException ( String msg ) { super(msg); }
		public TopicUnavailableException ( String msg, Throwable t ) { super(msg,t); }
	 ...
	 * @throws TopicUnavailableException if the topic name is not supported or somehow not available
	 */
	ContinualMessageSink getTopic ( String topic ) throws TopicUnavailableException;
