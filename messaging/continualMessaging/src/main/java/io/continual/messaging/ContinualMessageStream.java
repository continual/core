 ...
 * For example, one might label the stream of fault messages coming from a network element using the unique name of the
 * element.
 */
public class ContinualMessageStream
{
	...
	public ContinualMessageStream ( String name )
	{
		...
		Strings.throwIfEmpty ( fMessageStreamName,
			"A message stream name must be a string with at least one character." );
	}
