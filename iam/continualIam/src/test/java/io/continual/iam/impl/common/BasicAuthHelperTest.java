...
public class BasicAuthHelperTest extends TestCase
{
	...
	public void testReadUsernamePasswordCredential_NoAuth ()
	{
		...
		assertNull ( BasicAuthHelper.readUsernamePasswordCredential ( null , hr ) );
	}
	...
	public void testReadUsernamePasswordCredential_Valid ()
	{
		...
		final UsernamePasswordCredential upc = BasicAuthHelper.readUsernamePasswordCredential ( null , hr );
		assertNotNull ( upc );
