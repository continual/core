...
{
	public static JSONObject serialize ( FlowControlDeploymentRecord d, Encryptor enc )
	{
	...
	public static FlowControlDeploymentRecord deserialize ( JSONObject data )
	{
	...
	private static JSONObject serialize ( FlowControlDeploymentResourceSpec rs )
	{
		return new JSONObject ()
	...
	private static final class LocalDeployment implements FlowControlDeploymentRecord
	{
