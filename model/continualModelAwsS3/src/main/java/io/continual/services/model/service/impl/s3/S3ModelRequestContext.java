...
public class S3ModelRequestContext implements ModelRequestContext
{
	public S3ModelRequestContext ( UserContext user )
	{
		this ( user.getUser (), CacheControl.READ_AND_WRITE );
	}

	public S3ModelRequestContext ( Identity user )
	{
		this ( user, CacheControl.READ_AND_WRITE );	// FIXME: not actually running yet
	}

	public S3ModelRequestContext ( Identity user, CacheControl caching )
	{
		fUser = user;
