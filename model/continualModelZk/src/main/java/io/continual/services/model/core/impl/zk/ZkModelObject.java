...
class ZkModelObject implements ModelObject
{
	public ZkModelObject ( String id, JSONObject rawData )
	{
		fId = id;
	...
	{
		final JSONObject data = fRaw.optJSONObject ( ZookeeperModel.kUserDataTag );
